...
module multicoin::multicoin_tests {
    ...
    // Asset IDs for testing (arbitrary u64 values)
    const TOKEN_SWORD: u64 = 1;
    const TOKEN_SHIELD: u64 = 2;
    const TOKEN_POTION: u64 = 3;
    ...
    fun test_split_and_join() {
        ...
        let mut balance = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id,
            100,
    ...
    fun test_batch_mint() {
        ...
        {
            let mut collection = scenario.take_shared<Collection>();
            let asset_ids = vector[TOKEN_SWORD, TOKEN_SHIELD, TOKEN_POTION];
    ...
    fun test_burn() {
        ...
        let balance = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id,
            100,
    ...
    fun test_join_wrong_asset_id() {
        ...
        let mut balance1 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id1,
            100,
        ...
        let balance2 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id2,
            50,
    ...
    fun test_supply_overflow_protection() {
        ...
        let _balance1 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id,
        ...
        let _balance2 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id,
            10,
    ...
    fun test_supply_underflow_protection() {
        ...
        // Mint 100 assets
        let _balance = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id,
            100,
    ...
    fun test_asset_id_supply_isolation() {
        ...
        let balance_sword = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id_sword,
            100,
        ...
        let balance_shield = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id_shield,
            50,
        ...
        let balance_potion = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id_potion,
            200,
        ...
        let balance_sword2 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id_sword,
            25,
    ...
    fun test_asset_id_balance_operations_isolated() {
        ...
        let mut balance2 = multicoin::mint_and_keep(
            &cap,
            &mut collection,
            asset_id2,
            100,
    ...
    fun test_collection_isolation() {
        ...
        let balance1 = multicoin::mint_and_keep(
            &cap1,
            &mut collection1,
            asset_id,
            100,
